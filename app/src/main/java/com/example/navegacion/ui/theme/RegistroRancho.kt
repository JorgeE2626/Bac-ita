...
class RegistroRanchoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnEliminar).setOnClickListener {
            ...
            findViewById<EditText>(R.id.etHectareas).text.clear()
            findViewById<EditText>(R.id.etPropietario).text.clear()
            findViewById<EditText>(R.id.etVeterinario).text.clear()
        }
